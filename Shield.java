...
public class Shield {
    ...
    public static void main(String[] args) {
        ...
        List<Hero> elders = heroes.stream().filter(elder -> elder.getAge() > 59).collect(Collectors.toList());
        ...
        List<Hero> intolerants = heroes.stream().filter(intolerant -> intolerant.isGlutenIntolerant())
